<p align="center">
  ...
  <img src="https://img.shields.io/badge/Problems%20Solved-228-success?style=flat&logo=leetcode" />
</p>
...
| 3 | [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [C++](./Cpp/Longest-Substring-Without-Repeating-Characters.cpp) / [Rust](./Rust/Longest_Substring_Without_Repeating_Characters.rs) | _O(n)_ | _O(n)_ | Medium | Hash Table, String, Sliding Window |
| 4 | [Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/) | [C++](./Cpp/Median_of_Two_Sorted_Arrays.cpp) / [Rust](./Rust/Median_of_Two_Sorted_Arrays.rs) | _O(log(min(n1,n2)))_ | _O(1)_ | Hard | Array, Binary Search, Divide and Conquer |
...
| 2054 | [Two Best Non-Overlapping Events](https://leetcode.com/problems/two-best-non-overlapping-events/) | [C++](./Cpp/Two_Best_Non-Overlapping_Events.cpp) / [Rust](./Rust/Two_Best_Non-Overlapping_Events.rs) | _O(n log n)_ | _O(1)_ | Medium | Array, Binary Search, Dynamic Programming, Sorting, Heap (Priority Queue) |
